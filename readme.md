Este programa se opera llamando desde la consola utilizando comandos como:
...
De no encontrarse ese auto imprimirá "no se ha encontrado el vehiculo con la patente ingresada"
