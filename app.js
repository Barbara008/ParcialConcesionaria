let funcionalidadesApp = require('./funcionalidades');
...
switch(accion) {
    case 'listar':
        funcionalidadesApp.listar();
        break;

    case 'buscar':
        console.log(funcionalidadesApp.buscarAuto(parametroAdicional))
        break;

    case 'vender':
        funcionalidadesApp.venderAuto(parametroAdicional);
        break;
    
    case 'enVenta':
        console.log(funcionalidadesApp.autosParaLaVenta());
        break;

    case 'nuevos':
        console.log(funcionalidadesApp.autosNuevos());
        break;

    case 'listaVentas':
        console.log(funcionalidadesApp.listaDeVentas());
        break;

    case 'totalVentas':
        console.log(funcionalidadesApp.totalDeVentas());
        break;
    ...
    case 'puedeComprar':
        ...
        console.log(funcionalidadesApp.autosQuePuedeComprar(persona));
        break

    default:
        console.log('No entiendo qué me estás pidiendo');
        console.log('Las acciones disponibles son: vender, buscar, enVenta, nuevos, listaVentas, totalVentas, puedeComprar ');
        break;
}
